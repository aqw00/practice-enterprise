...
{
    public static void addFrame(ActionEvent e, List<String> csvEditList, JFrame frame, String pathWebsiteInfo, String pathButtonWebsites, String pathChrome, String csvFile, String sftpEncPass)
    {
        ...
        form.addWindowListener(new java.awt.event.WindowAdapter()
        {
            ...
            public void windowClosing(java.awt.event.WindowEvent windowEvent)
            {
                ...
                form.dispose();
                Website.webFrame(pathButtonWebsites, pathWebsiteInfo, csvEditList, pathChrome, csvFile, sftpEncPass);
            }
        });
