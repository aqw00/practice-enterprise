...
{
    public static void editFrame(ActionEvent e, List<String> items, List<String> list, JFrame frame, String pathWebsiteInfo, String pathButtonWebsites, String pathChrome, String csvFile, String sftpEncPass)
    {
        items.remove("ADD");
        items.remove("EDIT");
        items.remove("CLOSE");
